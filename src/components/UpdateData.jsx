  ...
  useEffect(() => {
    if (data && data.data) {
      const {
        ...
        motherName,
        marriedStatus,
        dateOfBirth,gov_vata,potibondhi
      } = data.data;
      ...
      setValue("gov_vata", gov_vata);
      setValue("potibondhi", potibondhi);
      setValue("marriedStatus", marriedStatus);
      setValue("dateOfBirth", dateOfBirth?.slice(0, 10));
    }
                          ...
                          <div className=" ">
                            ...
                            >
                              {isFetching ? (
                                ...
                                <>
                                  <option value="">{villageName}</option>
                                  {villageData?.village &&
