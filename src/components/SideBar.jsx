    ...
    <ul className="menu menu-sm   text-white   max-w-xs w-full space-y-3">
      <li className="text-white  bg-blue-600 rounded-md">
        ...
        >
          ...
          <p className="text-white">ড্যাশবোর্ড</p>
        </NavLink>
      </li>
      {userInfo &&
        (userInfo?.role === "admin" ||
          ...
          <>
              ...
              <details open>
                ...
                <ul className="mt-2">
                  <li>
                    <NavLink
                      onClick={() =>
                        handleToggleClick(() => setMobileMenuOpen(true))
                      }
                      to="/application-form"
                      className={({ isActive, isPending }) =>
                        `${isActive ? " glass text-white" : ""}`
                      }
                      type="button"
                    >
                      <FaWpforms className=" h-4" />
                      <p className="">আবেদন ফরম</p>
                    </NavLink>
                  </li>
                  <li>
                    <NavLink
                      ...
                      className={({ isActive, isPending }) =>
                        `${isActive ? " glass active:text-white" : ""}`
                      }
                      type="button"
                    >
                      <FcViewDetails className=" h-4" />
                      <p className="">এসেসমেন্ট তালিকা</p>
                    </NavLink>
                  </li>
                </ul>
              </details>
            ...
            <li>
              ...
              >
                ...
                <p className="">হোল্ডিং এবং কর যাচাই</p>
              </NavLink>
            </li>
          </>
        )}
          ...
          <details open>
            ...
            <ul>
              <li className="text-white mt-2">
                ...
                >
                  <FaBook className=" h-4 " />
                  <p className="">সকল ইউজার তালিকা</p>
                </NavLink>
              </li>
            </ul>
          </details>
      ...
      <div className="flex items-center p-2 mt-12 space-x-4 justify-self-end border   rounded-md ">
        <div className="relative group">
          <img
            className="size-[60px] bg-slate-500 object-cover rounded-full"
            src={userInfo?.image}
