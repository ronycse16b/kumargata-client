...
export default function Register() {
  ...
  return (
    <div className="w-full min-h-screen relative  bg-slate-300  flex flex-col sm:justify-center items-center pt-6 sm:pt-0 ">
      <div className="absolute top-0 border-b w-full border-t     ">
      ...
      <div className="w-full sm:max-w-md  p-10 mx-auto text-black  card border     rounded-tr-3xl my-4  ">
        ...
        <form onSubmit={handleSubmit} className="">
          ...
          <div className="mb-4">
            <input
              type="email"
              required
              placeholder="Enter valid email for forgot password"
              value={email}
          ...
          <div className="my-4">
            <p className="text-sm text-center sm:px-6 text-gray-900">
              Have an account?
              <Link
                to="/login"
