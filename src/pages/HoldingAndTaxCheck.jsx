...
export default function HoldingAndTaxCheck() {
    ...
    return (
        <div className="sm:p-10 p-2 relative  ">
        
                    <form
                        onSubmit={handleSubmit(onSubmit)}
                        className="flex flex-col lg:flex-row gap-2 max-w-[460px] sm:lg:max-w-[800px] items-center w-full print:hidden sm:px-5"
                    >
                        ...
                        <div className="lg:w-1/3 w-full">
                            <input
                                ...
                                name="searchQuery"
                                placeholder="Holding"
                                className="flex-grow w-full h-7 px-4 transition duration-200 bg-white border border-gray-300 rounded shadow-sm appearance-none focus:border-deep-purple-accent-400 focus:outline-none focus:shadow-outline"
                            /> 
                        </div>
                        <button
                            type="submit"
                            className="h-7 px-6 glass flex items-center gap-1 bg-green-600 text-white"
                        >
                            Find
                            <FaSearch />
                        </button>
                            ...
                            <>
                                <section className="text-gray-600 body-font    ">
                                    <div className="container px-5 py-16 mx-auto  ">
                                        <div className="flex  max-w-3xl border-2 glass shadow-md rounded bg-indigo-100 border-gray-200 border-opacity-50 p-8 sm:flex-row flex-col">
                                            <div className="flex-grow ">
                                                ...
                                                <div className="border border-gray-400 p-2 rounded-md my-4 text-center">
                                                    ...
                                                    {path === '/holding-check' && <h1 className="text-green-600  font-bold flex justify-center items-center">
                                                        {" "}
                                                    ...
                                                    {path === "/register-due" && (
                                                        // If the path is "register-due", render the following JSX
                                                        <h1 className="text-yellow-600 font-bold flex justify-center items-center">
                                                            <svg
                                                                xmlns="http://www.w3.org/2000/svg"
                                                                className="stroke-current shrink-0 h-6 w-6"
                                                                fill="none"
                                                            ...
                                                            আপানার বর্তমান বকেয়া{" "}
                                                            {searchResults?.data?.due > 0
                                                                ? `আছে ${convertToBengaliNumber(
                                                                    searchResults?.data?.due || 0
                                                                )} টাকা`
                                                                : "নাই"}
                                                        </h1>
